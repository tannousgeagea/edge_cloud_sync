...
def create_app() -> FastAPI:
    tags_metadata = [
        {
            "name": "Edge to Cloud Sync Routing API",
            "description": "Edge to Cloud asynchronious processing with celery and RabbitMQ Broker"
        }
    ]
    ...
    app = FastAPI(
        ...
        debug=True,
        title="Edge to Cloud asynchronious processing",
        summary="",
        version="0.0.1",
        contact={
            "name": "Tannous Geagea",
